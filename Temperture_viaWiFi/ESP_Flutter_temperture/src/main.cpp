...
#define FIREBASE_HOST "esp-flutter-project.firebaseio.com" //Do not include https:// in FIREBASE_HOST
#define FIREBASE_AUTH "o9pg7MrtzOyS4bKuIoWH92y5bNBFkcPCjRSqtb1c"
#define WIFI_SSID "Human-A1-711"
#define WIFI_PASSWORD "bsys12bsys34"
...
void loop() {
  ...
  if (isnan(event.temperature)) {
    ...
    M5.Lcd.println(F("Temp:"));
    M5.Lcd.setCursor(10, 0);
    M5.Lcd.println(event.temperature);
